...
This note collects the old 10-node, 3-silent/crash-node WAN data and the new Mahi-Mahi f=3 silence line into one machine-readable CSV.
...
| Protocol | Rates |
| --- | --- |
| Shortfin | 30K, 60K, 90K, 120K, 150K, 180K |
| Narwhal/Tusk | 30K, 60K, 90K, 120K, 150K, 180K |
| Wahoo | 30K, 60K, 90K, 120K, 150K, 180K |
| Mahi-Mahi | 30K, 60K, 100K, 120K, 140K, 150K, 180K |
